...
import org.readium.r2.shared.Publication.WebPublication.Metadata.ContentLayoutStyle
...
class Publication : WebPublication, Serializable {
    ...
    /** TODO: Add var userSettingsUIPreset & var userSettingsUIPresetUpdated -- LET IT to Aferdita **/
    ...
    fun contentLayout(language: String?) : ContentLayoutStyle {
        ...
        //return ContentLayoutStyle(language = language ?: metadata.languages.firstOrNull() ?: "", _readingProgression = metadata.readingProgression)
    ...
    fun addSelfLink(endPoint: String, baseURL: URL) {
        ...
        var manifestURL = baseURL.toURI().rawPath + "\\"+endPoint+"/manifest.json"
        this.links.add(Link(manifestURL, "application/webpub+json", true))
    }
